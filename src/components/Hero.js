                ...
                <div className="hero-grid">
                    <div className="hero-text reveal">
                        ...
                        <div className="hero-actions">
                            ...
                            <a href="https://drive.google.com/file/d/1WI0DoHy2U_LfyvHITNuXsNsaUeLz-MpT/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="hero-cv-btn">
